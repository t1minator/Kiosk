            ...
            function() {
                ...
                e.config(["$stateProvider", function(e) {
                    ...
                    e(function() {
						...
						if(t.formModel.patientDobDod<10 && t.formModel.patientDobDom<10)
							t.formModel.patientDobDob = '0'+t.formModel.patientDobDom+'/0'+t.formModel.patientDobDod+'/'+t.formModel.patientDobDoy;
						else if(t.formModel.patientDobDod<10 && t.formModel.patientDobDom>=10)
							t.formModel.patientDobDob = t.formModel.patientDobDom+'/0'+t.formModel.patientDobDod+'/'+t.formModel.patientDobDoy;
						else if(t.formModel.patientDobDod>=10 && t.formModel.patientDobDom<10)
							t.formModel.patientDobDob = '0'+t.formModel.patientDobDom+'/'+t.formModel.patientDobDod+'/'+t.formModel.patientDobDoy;
						else
							t.formModel.patientDobDob = t.formModel.patientDobDom+'/'+t.formModel.patientDobDod+'/'+t.formModel.patientDobDoy;
