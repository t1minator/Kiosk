...
! function e(t, n, r) {
    ...
    1: [function(e, t, n) {
        ! function() {
            "use strict";
            var e = ["pascalprecht.translate", "ngAnimate", "ngIdle", "ui.router", "inactivityModal", "translatePartialCacheLoader", "ngMeteor", "error", "config", "language", "auth", "exit", "session", "dinStorage", "scrollHght"],
            ...
            t.run(["$rootScope", "$translate", "$translatePartialCacheLoader", "$state", "$storage", function(e, t, n, r, i) {
                ...
                }), r.preferredLanguage("en"), r.fallbackLanguage("en"), r.useSanitizeValueStrategy("escaped"), n.otherwise("/language"), i.idle(120), i.timeout(60), e.setUrl("wss://the-dentist-is-in-alpha-45310.onmodulus.net/websocket")
            }]), t.constant("meteorUrl", "wss://the-dentist-is-in-alpha-45310.onmodulus.net/websocket"), t.factory("jwtOptions", function() {
                return {
			...
			function() {
                "use strict";
				angular.module("scrollHght", []).controller('hghtCtrl', function($scope) {
					$scope.curheight = window.innerHeight;
				});
			}(),
            function() {
                "use strict";
            ...
            function() {
                "use strict";
                var e = angular.module("dental", ["patient"]);
                e.config(["$stateProvider", function(e) {
                ...
                }]), e.controller("dentalController", ["$timeout", "$scope", "$rootScope", "$state", function(e, t, r, n) {
                    e(function() {
						...
						if(dayfield<10 && monthfield<10)
							t.formModel.patientDobDob = '0'+monthfield+'/0'+dayfield+'/'+t.formModel.patientDobDoy;
						else if(dayfield<10 && monthfield>=10)
							t.formModel.patientDobDob = monthfield+'/0'+dayfield+'/'+t.formModel.patientDobDoy;
						else if(dayfield>=10 && monthfield<10)
							t.formModel.patientDobDob = '0'+monthfield+'/'+dayfield+'/'+t.formModel.patientDobDoy;
						else
							t.formModel.patientDobDob = monthfield+'/'+dayfield+'/'+t.formModel.patientDobDoy;

						t.formModel.patientAddressState = t.formModel.patientAddressState.value;
                    ...
                    r.nextPageVoip = function() {
                        t.setStepCompleted('dental');
                        t.formStepCompletion.dental = true;
                        console.log('go to voip');
                        n.go('session.voip');
                    };
                }])
            }(),
            ...
            function() {
                ...
                }]), e.controller("languageController", ["$translate", "$scope", "$rootScope", "$state", "$window", function(e, t, ro, n, win) {
                    ro.changeLanguage = function(t) {
                        e.use(t), n.go("auth.code"),
                        $(".confirmContent .lang").attr('class','lang').addClass(t)
                    },
                    ro.confirmYes = function(){
                        $("#confirm").hide(),
                        n.go("language")
                    },
                    ro.confirmCancel = function(){
                        $("#confirm").hide()
                        //n.go("auth.code")
                    },
                    ro.backCodeScreen = function() {
                        $("#confirm").show()
                    }
                }])
            }(),
            function() {
                ...
                }]), e.controller("medicalController", ["$timeout", "$scope", "$rootScope", "$state", function(e, t,ro, n) {
                    e(function() {
            ...
            function() {
                "use strict";
                var e = angular.module("patient", ["ui.router", "ngIdle", "tooltipInput", "tooltipDropdown", "tooltipSelect"]);
                e.config(["$stateProvider", function(e) {
                ...
                }]), e.controller("patientController", ["$scope", "$rootScope", "$state", "$timeout", function(e, ro,  t, n) {
                    n(function() {
                    ...
                    e.setStepActive("patient"), e.patient = {
                        ...
                        dob: {
                            ...
                            doy: {
                                ...
                                setID: "yearField",
								maxlth:4,
								pattern:/^(19[2-9][0-9]|20[01][0-4])$/,
								index: 32,
                                name: "patientDobDoy",
                                transRoot: "PATIENT.DOB.DOY"
                            }
                        },
                        sex: {
                            sex: {
            ...
            function() {
                ...
                }]), e.controller("voipController", ["$scope", "$rootScope", "$state", "$jwtMessage", "_", "$meteor", "$kioskMethods", function(e, ro, t, n, r, i, a) {
            ...
            function() {
                "use strict";
                var e = angular.module("dateNextField", []);
				e.directive("moveNextOnMaxlength", function() {
					return {
						restrict: "A",
						link: function($scope, n) {
							n.on("input", function(e) {
								var tabindex = n.attr("tabindex");
								if(n.val().length == n.attr("maxlength")) {
									tabindex++;
									var $nextElement = $('[tabindex=' + tabindex + ']');
			...
			function() {
                "use strict";
                var e = angular.module("tooltipSelect", []);
                e.directive("dinTooltipSelect", ["$translate", "$timeout", function(e, t) {
                    return {
                        require: [],
                        restrict: "E",
                        scope: {
                        ...
                        templateUrl: "views/partials/tooltip_select.partial.html",
                        transclude: !0,
                        link: function(e, n) {
                            var r = n.find(".ui.selection.select");
                            t(function() {
                                e.dinModel && r.select("set selected", e.dinModel), r.select({
                                    allowTab: !0,
                                    onChange: function(t) {
                                        void 0 !== t && e.dinForm !== t && e.dinForm[e.dinOptions.name].$setViewValue(t)
                                    }
            ...
            function() {
                "use strict";
                var e = angular.module("tooltipInput", ["dateFormat", "dateNextField", "ngLodash"]);
