! function e(t, n, r) {
    ...
    1: [function(e, t, n) {
        ! function() {
            ...
            function() {
                "use strict";
                var e = angular.module("patient", ["ui.router", "ngIdle", "ngAnimate", "ui.bootstrap", "tooltipInput", "tooltipDropdown"]);
                e.config(["$stateProvider", function(e) {
				...
				console.log("1="+e),
				  ...
				  e.minDate = new Date(),
				  e.maxDate = new Date(),
				  console.log("2= "+e.minDate),				
					
				  e.open = function($event) {
					e.status.opened = true;
				  },
				  ...
				  e.getDayClass = function(date, mode) {
					if (mode === 'day') {
					  var dayToCheck = new Date(date).setHours(0,0,0,0);

					  for (var i=0;i<e.events.length;i++){
						var currentDay = new Date(e.events[i].date).setHours(0,0,0,0);

						if (dayToCheck === currentDay) {
						  return e.events[i].status;
						}
					  }
					}
					return '';
