...
! function e(t, n, r) {
    ...
    1: [function(e, t, n) {
        ! function() {
            "use strict";
            var e = ["pascalprecht.translate", "ngAnimate", "ngIdle", "ui.router", "inactivityModal", "translatePartialCacheLoader", "ngMeteor", "error", "config", "language", "auth", "exit", "session", "dinStorage", "scrollHght", "ngCookies"],
            ...
            function() {
                "use strict";
                var e = angular.module("config", ["ui.router", "ngJwtMessage", "ngMeteor", "dinStorage", "kioskMethods", "ngCookies"]);
                e.config(["$stateProvider", function(e) {
                    e.state("config", {
                        url: "/config",
                ...
                }]), e.controller("configController", ["$translate", "$cookieStore", "$scope", "$state", "$jwtMessage", "$meteor", "$storage", "$kioskMethods", function(e, c, t, n, r, i, a, o) {
                    a.clear(), t.configModel, t.configSubmit = function() {
						c.put('key',t.configModel.key);
						c.put('secret',t.configModel.secret);
						
						console.log("Avanish -- key -- " + c.get('key'));
						console.log("Avanish -- secret -- " + c.get('secret'));
